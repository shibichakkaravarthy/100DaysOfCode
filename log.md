...
### Day 21: February 28, 2019
Today's Progress: Tried a way to add Billed items and still failing with compile time error and logical errors. 
...
### Day 22: March 1, 2019
Today's Progress: Working with CSS

Thoughts: Styles are more important than we think. It motivates the user to explore our app further and further.

**Link to work:**Clone my repository into your Computer and run 'npm install' and then 'npm start'


### Day 23: March 2, 2019
Today's Progress: Same as Yesterday... Working with CSS
...
### Day 24: March 3, 2019
Today's Progress: Created a Signin and Register Page for the App
...
### Day 25: March 4, 2019
Today's Progress: Again tried to find a way to add billed items to the database

Thoughts: Patience Tolerance can give us more knowledge and Experience .

**Link to work:**Clone my repository into your Computer and run 'npm install' and then 'npm start'


### Day 26: March 5, 2019
Today's Progress: As my efforts on adding the billed items to database failed, I again started Working with CSS

Thoughts: Move on when you fell stressed about something.
...
### Day 28: March 7, 2019
Today's Progress: Working with CSSTold my problem with adding billed items to the database to my Sister and had a long discussion and                     Experiments on code. We tried changing the code in Various methods But finally arrived at the same Error :-(
...
### Day 29: March 8, 2019
Today's Progress: Holly Molly!!! Finally biled items are added to the database... Found what was the issue and solved it.
...
Today's Progress:  Added styles and hover effects to the Dashboard component.
...
Today's Progress:  Changed some content of the Dashboard. Filtered the bill using the dates. My Hard disk was corrupted and Now I'm trying to recover my files. I don't have backup code for this 100DaysOfCode in github due to some network connectivity issues
